...
class ReasonAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Reason Details', {
            'fields': ('text', 'mood_type', 'category', 'is_generic')
        }),
    )
...
class ActionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Action Details', {
            'fields': ('text', 'category', 'is_generic')
        }),
        ('Related Reasons', {
            'fields': ('reasons',),
...
class MoodEntryAdmin(admin.ModelAdmin):
    list_display = ['user', 'mood', 'reason', 'action', 'action_worked',
                    'created_at']
    ...
    fieldsets = (
        ...
        ('Mood Data', {
            'fields': ('mood', 'reason', 'action', 'notes')
        }),
        ('Effectiveness', {
